...
#define ABCDK_RECEIVER_PROTO_RTCP ABCDK_RECEIVER_PROTO_RTCP
    ...
    ABCDK_RECEIVER_PROTO_NBT = 4,
#define ABCDK_RECEIVER_PROTO_NBT ABCDK_RECEIVER_PROTO_NBT

    /**NBT-Half */
    ABCDK_RECEIVER_PROTO_NBT_HALF = 5
#define ABCDK_RECEIVER_PROTO_NBT_HALF ABCDK_RECEIVER_PROTO_NBT_HALF
