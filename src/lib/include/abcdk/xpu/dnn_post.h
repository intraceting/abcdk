...
/**后处理环境.*/
typedef struct _abcdk_xpu_dnn_post abcdk_xpu_dnn_post_t;
 ...
 * 初始化.
 * 
 * @param [in] name 模形名字.目前仅支持：yolo-v11, yolo-v11-obb, yolo-v11-pose, face-yunet.
 *
 * @return 0 成功, -1 失败.
 */
