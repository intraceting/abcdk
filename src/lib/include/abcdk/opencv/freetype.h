 ...
 *
 */
#ifndef ABCDK_OPENCV_FREETYPE_H
#define ABCDK_OPENCV_FREETYPE_H
...
/**简单的文字引擎。*/
typedef struct _abcdk_opencv_freetype abcdk_opencv_freetype_t;
