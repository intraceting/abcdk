    ...
    namespace general
    {
        namespace imgproc
        {
                          ...
                          image::metadata_t **xmap, image::metadata_t **ymap)
            {
                ...
                *xmap = image::create(size->width,size->height,ABCDK_XPU_PIXFMT_GRAYF32,16);
                *ymap = image::create(size->width,size->height,ABCDK_XPU_PIXFMT_GRAYF32,16);
                ...
                image::copy(tmp_xmap.data, tmp_xmap.step, *xmap, 0);
                image::copy(tmp_ymap.data, tmp_ymap.step, *ymap, 0);
