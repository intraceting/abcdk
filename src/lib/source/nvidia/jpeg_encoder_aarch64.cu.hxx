 ...
 *
 */
#ifndef ABCDK_NVIDIA_JPEG_ENCODER_AARCH64_HXX
#define ABCDK_NVIDIA_JPEG_ENCODER_AARCH64_HXX
        ...
        namespace jpeg
        {
            ...
            public:
                ...
                virtual abcdk_object_t *update(const abcdk_torch_image_t *src)
                {
                    ...
                    {
                        tmp_src = abcdk_cuda_frame_create(src->width, src->height, ABCDK_TORCH_PIXFMT_YUV420P, 1);
                        if (!tmp_src)
                            return NULL;
...
#endif // ABCDK_NVIDIA_JPEG_ENCODER_AARCH64_HXX