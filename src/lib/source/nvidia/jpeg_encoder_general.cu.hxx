 ...
 *
 */
#ifndef ABCDK_NVIDIA_JPEG_ENCODER_GENERAL_HXX
#define ABCDK_NVIDIA_JPEG_ENCODER_GENERAL_HXX
        ...
        namespace jpeg
        {
            ...
            public:
                ...
                virtual abcdk_object_t *update(const abcdk_torch_image_t *src)
                {
                    ...
                    {
                        tmp_src = abcdk_cuda_image_create(src->width, src->height,  ABCDK_TORCH_PIXFMT_RGB24, 1);
                        if (!tmp_src)
                            return NULL;
...
#endif // ABCDK_NVIDIA_JPEG_ENCODER_GENERAL_HXX