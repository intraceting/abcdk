...
template <typename T>
ABCDK_INVOKE_HOST void _abcdk_torch_imgproc_compose_1d_host(int channels, bool packed,
...
template <typename T>
ABCDK_INVOKE_HOST int _abcdk_torch_imgproc_compose_host(int channels, bool packed,
                                                        T *panorama, size_t panorama_w, size_t panorama_ws, size_t panorama_h,
                                                        T *compose, size_t compose_w, size_t compose_ws, size_t compose_h,
