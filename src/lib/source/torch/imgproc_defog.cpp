                                                 ...
                                                 uint32_t dack_a, float dack_m, float dack_w)
{
    ...
    _abcdk_torch_imgproc_defog_1d<T>(channels, packed, dst, dst_w, dst_ws, dst_h, dack_a, dack_m, dack_w);
...
int abcdk_torch_imgproc_defog(abcdk_torch_image_t *dst, uint32_t dack_a, float dack_m, float dack_w)
{
    int dst_depth;
