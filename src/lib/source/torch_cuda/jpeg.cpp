...
typedef struct _abcdk_torch_jcodec_cuda
{
    ...
    /**编码器。*/
    abcdk::torch_cuda::jpeg::encoder *encoder_ctx;

    /**解码器。*/
    abcdk::torch_cuda::jpeg::decoder *decoder_ctx;
...
void abcdk_torch_jcodec_free_cuda(abcdk_torch_jcodec_t **ctx)
{
    ...
    *ctx = NULL;
    ...
    {
#ifdef __x86_64__
        abcdk::torch_cuda::jpeg::encoder_general::destory(&cu_ctx_p->encoder_ctx);
#elif defined(__aarch64__)
        abcdk::torch_cuda::jpeg::encoder_aarch64::destory(&cu_ctx_p->encoder_ctx);
#endif //__x86_64__ || __aarch64__
    }
    else
    {
#ifdef __x86_64__
        abcdk::torch_cuda::jpeg::decoder_general::destory(&cu_ctx_p->decoder_ctx);
#elif defined(__aarch64__)
        abcdk::torch_cuda::jpeg::decoder_aarch64::destory(&cu_ctx_p->decoder_ctx);
#endif //__x86_64__ || __aarch64__
    }
...
abcdk_torch_jcodec_t *abcdk_torch_jcodec_alloc_cuda(int encoder)
{
    ...
    {
#ifdef __x86_64__
        cu_ctx_p->encoder_ctx = abcdk::torch_cuda::jpeg::encoder_general::create((CUcontext)(abcdk_torch_context_current_get_cuda()->private_ctx));
#elif defined(__aarch64__)
        cu_ctx_p->encoder_ctx = abcdk::torch_cuda::jpeg::encoder_aarch64::create((CUcontext)(abcdk_torch_context_current_get_cuda()->private_ctx));
#endif //__x86_64__ || __aarch64__
    ...
    {
#ifdef __x86_64__
        cu_ctx_p->decoder_ctx = abcdk::torch_cuda::jpeg::decoder_general::create((CUcontext)(abcdk_torch_context_current_get_cuda()->private_ctx));
#elif defined(__aarch64__)
        cu_ctx_p->decoder_ctx = abcdk::torch_cuda::jpeg::decoder_aarch64::create((CUcontext)(abcdk_torch_context_current_get_cuda()->private_ctx));
#endif //__x86_64__ || __aarch64__
