...
static int _abcdk_torch_imgproc_resize_8u_cuda(int channels, int packed,
                                               ...
                                               int keep_aspect_ratio, int inter_mode)
{
    ...
    if (channels == 1)
    {
        npp_chk = nppiResizeSqrPixel_8u_C1R(src, tmp_src_size, src_ws, tmp_src_roi,
                                            ...
                                            tmp_param.x_factor, tmp_param.y_factor, tmp_param.x_shift, tmp_param.y_shift, inter_mode);
    }
    else if (channels == 3)
    {
                                    ...
                                    int keep_aspect_ratio, int inter_mode)
{
    ...
    return _abcdk_torch_imgproc_resize_8u_cuda(dst_depth, true,
