 ...
 *
 */
#ifndef ABCDK_TORCH_NVIDIA_VCODEC_DECODER_FFNV_HXX
#define ABCDK_TORCH_NVIDIA_VCODEC_DECODER_FFNV_HXX
        ...
        namespace vcodec
        {
            ...
            protected:
                ...
                int picture_display(CUVIDPARSERDISPINFO *info)
                {
                    ...
                    tmp_src.tag = ABCDK_TORCH_TAG_CUDA;
                    ...
                    frame_src = abcdk_torch_frame_create_cuda(tmp_src.width, tmp_src.height, tmp_src.pixfmt, 1);
                    if (frame_src)
                    {
                        abcdk_torch_image_copy_cuda(frame_src->img, &tmp_src);
...
#endif // ABCDK_TORCH_NVIDIA_VCODEC_DECODER_FFNV_HXX