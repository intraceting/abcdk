...
void _abcdkmcdump_print_usage(abcdk_option_t *args)
{
    fprintf(stderr, "\n描述:\n");
...
void _abcdkmcdump_work(abcdkmcdump_t *ctx)
{
...
int abcdk_tool_mcdump(abcdk_option_t *args)
{
    ...
    {
        _abcdkmcdump_print_usage(ctx.args);
    }
    else
    {
        _abcdkmcdump_work(&ctx);
    }
