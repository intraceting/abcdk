...
#define ABCDK_MP4_FILE_BRAND_QT__ ABCDK_MP4_ATOM_MKTAG('q', 't', ' ', ' ')
#define ABCDK_MP4_FILE_BRAND_ISOM ABCDK_MP4_ATOM_MKTAG('i', 's', 'o', 'm')
#define ABCDK_MP4_FILE_BRAND_ISO1 ABCDK_MP4_ATOM_MKTAG('i', 's', 'o', '1')
#define ABCDK_MP4_FILE_BRAND_ISO2 ABCDK_MP4_ATOM_MKTAG('i', 's', 'o', '2')
#define ABCDK_MP4_FILE_BRAND_ISO3 ABCDK_MP4_ATOM_MKTAG('i', 's', 'o', '3')
#define ABCDK_MP4_FILE_BRAND_ISO4 ABCDK_MP4_ATOM_MKTAG('i', 's', 'o', '4')
#define ABCDK_MP4_FILE_BRAND_ISO5 ABCDK_MP4_ATOM_MKTAG('i', 's', 'o', '5')
#define ABCDK_MP4_FILE_BRAND_ISO6 ABCDK_MP4_ATOM_MKTAG('i', 's', 'o', '6')
#define ABCDK_MP4_FILE_BRAND_MP41 ABCDK_MP4_ATOM_MKTAG('m', 'p', '4', '1')
#define ABCDK_MP4_FILE_BRAND_MP42 ABCDK_MP4_ATOM_MKTAG('m', 'p', '4', '2')
#define ABCDK_MP4_FILE_BRAND_3GP1 ABCDK_MP4_ATOM_MKTAG('3', 'g', 'p', '1')
#define ABCDK_MP4_FILE_BRAND_3GP2 ABCDK_MP4_ATOM_MKTAG('3', 'g', 'p', '2')
#define ABCDK_MP4_FILE_BRAND_3GP3 ABCDK_MP4_ATOM_MKTAG('3', 'g', 'p', '3')
#define ABCDK_MP4_FILE_BRAND_3GP4 ABCDK_MP4_ATOM_MKTAG('3', 'g', 'p', '4')
#define ABCDK_MP4_FILE_BRAND_3GP5 ABCDK_MP4_ATOM_MKTAG('3', 'g', 'p', '5')
#define ABCDK_MP4_FILE_BRAND_3G2A ABCDK_MP4_ATOM_MKTAG('3', 'g', '2', 'a')
#define ABCDK_MP4_FILE_BRAND_MMP4 ABCDK_MP4_ATOM_MKTAG('m', 'm', 'p', '4')
#define ABCDK_MP4_FILE_BRAND_M4A_ ABCDK_MP4_ATOM_MKTAG('M', '4', 'A', ' ')
#define ABCDK_MP4_FILE_BRAND_M4P_ ABCDK_MP4_ATOM_MKTAG('M', '4', 'P', ' ')
#define ABCDK_MP4_FILE_BRAND_MJP2 ABCDK_MP4_ATOM_MKTAG('m', 'j', 'p', '2')
#define ABCDK_MP4_FILE_BRAND_ODCF ABCDK_MP4_ATOM_MKTAG('o', 'd', 'c', 'f')
#define ABCDK_MP4_FILE_BRAND_OPF2 ABCDK_MP4_ATOM_MKTAG('o', 'p', 'f', '2')
#define ABCDK_MP4_FILE_BRAND_AVC1 ABCDK_MP4_ATOM_MKTAG('a', 'v', 'c', '1')
