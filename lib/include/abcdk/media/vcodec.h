 ...
 *
 */
#ifndef ABCDK_MEDIA_VCODEC_H
#define ABCDK_MEDIA_VCODEC_H
...
#define ABCDK_MEDIA_VCODEC_NONE ABCDK_MEDIA_VCODEC_NONE

    ABCDK_MEDIA_VCODEC_H264,
#define ABCDK_MEDIA_VCODEC_H264 ABCDK_MEDIA_VCODEC_H264

    ABCDK_MEDIA_VCODEC_HEVC,
#define ABCDK_MEDIA_VCODEC_HEVC ABCDK_MEDIA_VCODEC_HEVC

    ABCDK_MEDIA_VCODEC_MJPEG,
#define ABCDK_MEDIA_VCODEC_MJPEG ABCDK_MEDIA_VCODEC_MJPEG

    ABCDK_MEDIA_VCODEC_MPEG1VIDEO,
#define ABCDK_MEDIA_VCODEC_MPEG1VIDEO ABCDK_MEDIA_VCODEC_MPEG1VIDEO

    ABCDK_MEDIA_VCODEC_MPEG2VIDEO,
#define ABCDK_MEDIA_VCODEC_MPEG2VIDEO ABCDK_MEDIA_VCODEC_MPEG2VIDEO

    ABCDK_MEDIA_VCODEC_MPEG4,
#define ABCDK_MEDIA_VCODEC_MPEG4 ABCDK_MEDIA_VCODEC_MPEG4

    ABCDK_MEDIA_VCODEC_VC1,
#define ABCDK_MEDIA_VCODEC_VC1 ABCDK_MEDIA_VCODEC_VC1

    ABCDK_MEDIA_VCODEC_VP8,
#define ABCDK_MEDIA_VCODEC_VP8 ABCDK_MEDIA_VCODEC_VP8

    ABCDK_MEDIA_VCODEC_VP9,
#define ABCDK_MEDIA_VCODEC_VP9 ABCDK_MEDIA_VCODEC_VP9

    ABCDK_MEDIA_VCODEC_WMV3,
#define ABCDK_MEDIA_VCODEC_WMV3 ABCDK_MEDIA_VCODEC_WMV3
