    ...
    namespace generic
    {
        namespace tensorproc
        {
                                                    ...
                                                    size_t tid)
            {
                ...
                size_t src_of = abcdk::generic::util::off<T>(src_packed, src_w, src_ws, src_h, src_c, src_n, src_x, src_y, src_z);
                size_t dst_of = abcdk::generic::util::off<T>(dst_packed, dst_w, dst_ws, dst_h, dst_c, dst_n, dst_x, dst_y, dst_z);

                *abcdk::generic::util::ptr<T>(dst, dst_of) = abcdk::generic::util::obj<T>(src, src_of);
            }
