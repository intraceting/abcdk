 ...
 *
 */
#ifndef ABCDK_IMPL_IMAGEPROC_DEFOG_HXX
#define ABCDK_IMPL_IMAGEPROC_DEFOG_HXX
    ...
    namespace imageproc
    {
                                              ...
                                              size_t tid)
        {
            ...
            for (size_t z = 0; z < channels; z++)
            {
                ...
                if (dack_c > abcdk::general::obj<T>(src, src_of[z]))
                    dack_c = abcdk::general::obj<T>(src, src_of[z]);
            }
            ...
            for (size_t z = 0; z < channels; z++)
            {
                *abcdk::general::ptr<T>(dst, dst_of[z]) = abcdk::general::pixel_clamp<T>(((abcdk::general::obj<T>(src, src_of[z]) - dack_a) / t + dack_a));
            }
        }
...
#endif // ABCDK_IMPL_IMAGEPROC_DEFOG_HXX