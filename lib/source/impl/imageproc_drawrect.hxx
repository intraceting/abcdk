 ...
 *
 */
#ifndef ABCDK_IMPL_IMAGEPROC_DRAWRECT_HXX
#define ABCDK_IMPL_IMAGEPROC_DRAWRECT_HXX
    ...
    namespace imageproc
    {
                                                 ...
                                                 size_t tid)
        {
            ...
            for (size_t z = 0; z < channels; z++)
            {
                ...
                *abcdk::general::ptr<T>(dst,off) = color[z];
            }
        }
...
#endif // ABCDK_IMPL_IMAGEPROC_DRAWRECT_HXX