 ...
 *
 */
#ifndef ABCDK_NVIDIA_JPEG_DECODER_AARCH64_HXX
#define ABCDK_NVIDIA_JPEG_DECODER_AARCH64_HXX
            ...
            public:
                ...
                virtual abcdk_torch_image_t * update(const void *src, int src_size)
                {
                    ...
                    if(pixfmt == V4L2_PIX_FMT_YUV420M)
                        dst = abcdk_cuda_frame_create(width,height,ABCDK_TORCH_PIXFMT_YUV420P,1);
                    else if(pixfmt == V4L2_PIX_FMT_YUV422M)
                        dst = abcdk_cuda_frame_create(width,height,ABCDK_TORCH_PIXFMT_YUV422P,1);
                    else if(pixfmt == V4L2_PIX_FMT_YUV444M)
                        dst = abcdk_cuda_frame_create(width,height,ABCDK_TORCH_PIXFMT_YUV444P,1);
                    else 
                        return NULL;
...
#endif // ABCDK_NVIDIA_JPEG_DECODER_AARCH64_HXX