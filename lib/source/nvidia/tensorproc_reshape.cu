...
ABCDK_INVOKE_GLOBAL void _abcdk_cuda_tensorproc_reshape_2d2d(bool dst_packed, uint8_t *dst, size_t dst_b, size_t dst_w, size_t dst_ws, size_t dst_h, size_t dst_c,
...
ABCDK_INVOKE_HOST int _abcdk_cuda_tensorproc_reshape(bool dst_packed, uint8_t *dst, size_t dst_b, size_t dst_w, size_t dst_ws, size_t dst_h, size_t dst_c,
                                                     bool src_packed, uint8_t *src, size_t src_b, size_t src_w, size_t src_ws, size_t src_h, size_t src_c,
                                                     size_t cell)
{
    ...
    _abcdk_cuda_tensorproc_reshape_2d2d<<<dim[0], dim[1]>>>(dst_packed, dst, dst_b, dst_w, dst_ws, dst_h, dst_c,
                                                            src_packed, src, src_b, src_w, src_ws, src_h, src_c,
                                                            cell);
...
int abcdk_cuda_tensorproc_reshape(abcdk_torch_tensor_t *dst, const abcdk_torch_tensor_t *src)
{
    ...
    return _abcdk_cuda_tensorproc_reshape((dst->format == ABCDK_TORCH_TENFMT_NHWC), dst->data, dst->block, dst->width, dst->stride, dst->height, dst->depth,
