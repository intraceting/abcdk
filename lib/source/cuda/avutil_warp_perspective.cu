...
static void _abcdk_cuda_avframe_warp_free_tmp(AVFrame *dst, const AVFrame *src, AVFrame *tmp_dst, AVFrame *tmp_src)
{
    if (tmp_dst != dst)
                                        ...
                                        int back, NppiInterpolationMode inter_mode)
{
    ...
    if (!tmp_dst || !tmp_src)
    {
        _abcdk_cuda_avframe_warp_free_tmp(dst, src, tmp_dst, tmp_src);
        return -1;
    }
    ...
    tmp_quad_roi.width = (quad_roi ? quad_roi->width : tmp_dst->width);
    tmp_quad_roi.height = (quad_roi ? quad_roi->height : tmp_dst->height);
    ...
    if (src->format == (int)AV_PIX_FMT_GRAY8)
    {
        ...
        {
            /*多边型向矩形变换。*/
            npp_chk = nppiWarpPerspectiveBack_8u_C1R(tmp_src->data[0], tmp_src_size, tmp_src->linesize[0], tmp_src_roi,
        ...
        {
            /*矩形向多边型变换。*/
            npp_chk = nppiWarpPerspective_8u_C1R(tmp_src->data[0], tmp_src_size, tmp_src->linesize[0], tmp_src_roi,
                                                 tmp_dst->data[0], tmp_dst->linesize[0], tmp_dst_roi,
                                                 tmp_coeffs, (int)inter_mode);
        }
    }
    else if (src->format == (int)AV_PIX_FMT_RGB24 || src->format == (int)AV_PIX_FMT_BGR24)
    {
        ...
        {
            /*多边型向矩形变换。*/
            npp_chk = nppiWarpPerspectiveBack_8u_C3R(tmp_src->data[0], tmp_src_size, tmp_src->linesize[0], tmp_src_roi,
                                                     tmp_dst->data[0], tmp_dst->linesize[0], tmp_dst_roi,
                                                     tmp_coeffs, (int)inter_mode);
        }
        else
        {
            /*矩形向多边型变换。*/
            npp_chk = nppiWarpPerspective_8u_C3R(tmp_src->data[0], tmp_src_size, tmp_src->linesize[0], tmp_src_roi,
                                                 tmp_dst->data[0], tmp_dst->linesize[0], tmp_dst_roi,
                                                 tmp_coeffs, (int)inter_mode);
        }
    }
    else if (src->format == (int)AV_PIX_FMT_RGB32 || src->format == (int)AV_PIX_FMT_BGR32)
    {
        ...
        {
            /*多边型向矩形变换。*/
            npp_chk = nppiWarpPerspectiveBack_8u_C4R(tmp_src->data[0], tmp_src_size, tmp_src->linesize[0], tmp_src_roi,
                                                     tmp_dst->data[0], tmp_dst->linesize[0], tmp_dst_roi,
                                                     tmp_coeffs, (int)inter_mode);
        }
        else
        {
            /*矩形向多边型变换。*/
            npp_chk = nppiWarpPerspective_8u_C4R(tmp_src->data[0], tmp_src_size, tmp_src->linesize[0], tmp_src_roi,
                                                 tmp_dst->data[0], tmp_dst->linesize[0], tmp_dst_roi,
                                                 tmp_coeffs, (int)inter_mode);
        }
    }
