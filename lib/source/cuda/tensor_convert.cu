...
ABCDK_CUDA_GLOBAL void _abcdk_cuda_tensor_convert_2d2d(int channels,
                                                       bool dst_packed, DT *dst, size_t dst_ws,
                                                       bool src_packed, ST *src, size_t src_ws,
                                                       size_t w, size_t h,
                                                       float *scale, float *mean, float *std, bool revert)
{
...
template <class ST, class DT>
ABCDK_CUDA_HOST int _abcdk_cuda_tensor_convert(int channels,
                                               bool dst_packed, DT *dst, size_t dst_ws,
                                               bool src_packed, ST *src, size_t src_ws,
                                               size_t w, size_t h,
                                               float *scale, float *mean, float *std)
{
    ...
    _abcdk_cuda_tensor_convert_2d2d<ST, DT><<<dim[0], dim[1]>>>(channels, dst_packed, dst, dst_ws, src_packed, src, src_ws, w, h, (float *)gpu_scale, (float *)gpu_mean, (float *)gpu_std);
...
int abcdk_cuda_tensor_convert_8u_to_32f_3r(int dst_packed, float *dst, size_t dst_ws,
                                           ...
                                           size_t w, size_t h, float scale[3], float mean[3], float std[3])
{
    ...
    return _abcdk_cuda_tensor_convert<uint8_t, float>(3, dst_packed, dst, dst_ws, src_packed, src, src_ws, w, h, scale, mean, std);
}
