...
#
RT_PACKAGE_NAME=abcdk-${VERSION_STR_FULL}-${TARGET_PLATFORM}${PACKAGE_SUFFIX}
DEV_PACKAGE_NAME=abcdk-dev-${VERSION_STR_FULL}-${TARGET_PLATFORM}${PACKAGE_SUFFIX}
UTIL_PACKAGE_NAME=abcdk-util-${VERSION_STR_FULL}-${TARGET_PLATFORM}${PACKAGE_SUFFIX}
