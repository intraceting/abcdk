...
DEV_PACKAGE_NAME=abcdk-dev${PACKAGE_SUFFIX}-${VERSION_STR_FULL}-${TARGET_PLATFORM}
UTIL_PACKAGE_NAME=abcdk-util${PACKAGE_SUFFIX}-${VERSION_STR_FULL}-${TARGET_PLATFORM}
